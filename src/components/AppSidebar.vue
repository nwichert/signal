...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { name: 'Executive Dashboard', path: '/executive-dashboard', icon: 'chart-bar', roles: ['cpo', 'leadership'] },
    ]
  },
  {
    label: 'Strategy',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Design Partners', path: '/design-partners', icon: 'handshake', roles: ['cpo', 'team'] },
...
const iconPaths: Record<string, string> = {
  ...
  handshake: 'M7 11l4-4 4 4M7 11v6a2 2 0 002 2h6a2 2 0 002-2v-6M7 11H4a1 1 0 01-1-1V7a1 1 0 011-1h3m10 5h3a1 1 0 001-1V7a1 1 0 00-1-1h-3',
...
<template>
  ...
  >
    ...
    <div class="flex h-16 items-center justify-between px-4 border-b border-gray-800">
      <img
        v-if="!collapsed"
        src="@/assets/signal_logo_white.png"
        alt="Signal"
        class="h-8 w-auto"
      />
      <button
